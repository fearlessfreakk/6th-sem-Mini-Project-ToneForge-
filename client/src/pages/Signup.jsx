...
import { Mail, Lock, UserPlus, ArrowRight, Sparkles, ShieldCheck } from 'lucide-react';
                ...
                <div className="glass rounded-[3rem] p-10 shadow-2xl border-indigo-500/10">
                    <div className="text-center mb-10">
                        ...
                        <p className="text-gray-500 dark:text-gray-400 font-medium tracking-tight">
                            Create an account to start refining your communication.
                        </p>
                    </div>
                    ...
                    <form className="space-y-5" onSubmit={handleSubmit}>
                        <div className="space-y-4">
                            ...
                            <div className="relative group">
                                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <ShieldCheck size={18} className="text-gray-400 group-focus-within:text-indigo-500 transition-colors" />
                                </div>
                                <input
                                    type="password"
                                    required
